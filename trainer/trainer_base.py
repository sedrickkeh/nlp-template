"""
Reference: https://github.com/ahmetgunduz/pytorch-nlp-project-template
"""
...
class BaseTrainer:
    ...
    def _save_checkpoint(self, epoch, save_best=False):
        ...
        filename = str("{}/checkpoint-epoch{}.pth".format(self.checkpoint_dir, epoch))
        torch.save(state, filename)
        self.logger.info("Saving checkpoint: {} ...".format(filename))
        if save_best:
            best_path = str("{}/model_best.pth".format(self.checkpoint_dir))
